...
const Info = [
  {
    icon: <FaPhoneAlt />,
    title: 'Phone',
    description: '(+20) 01142019787',
  },
  {
    icon: <FaPhoneAlt />,
    title: 'Phone',
    description: '(+20) 01080243774',
  },
  {
    icon: <FaEnvelope />,
    title: 'Email',
    description: 'abdullahali@gmail.com',
  },
  {
    icon: <FaMapMarkedAlt />,
    title: 'Address',
    description: 'Beni Mazar Center, Minya Governorate',
  },
]
...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        'service_8z5gh8q',   // حط الـ Service ID من EmailJS
        'template_uzt5avl',  // حط الـ Template ID من EmailJS
        form.current,
        "gLfzjQ_pAzSg8zSZ9",  // حط الـ Public Key من EmailJS
      )
      .then(
        (result) => {
